...
This repository contains the Unity project for the \*\*VR Multimodal Sketching\*\* assignment,

developed as part of Virtual Reality's IST course.
...
The main scene for the project is located at: 
...
- The project uses URP and XR packages already configured.
- No additional setup is required beyond opening the project.
- If prompted, enable the **Input System** and restart Unity.
